...
const socket = new WebSocket('wss://hhkdp5yfc2.execute-api.us-east-1.amazonaws.com/production')
...
let drawChart = function (data) {
    ...
    //console.log(IoT_Payload.temperature);
        ...
        humArr.push(Number(IoT_Payload.humedad));
        tempArr.push(Number(IoT_Payload.temperatura));
    ...
    let drawChart2 = function (data) {
        ...
        var newVal = (IoT_Payload.temperatura);
    ...
    let drawChart3 = function (data) {
        ...
        var newVal = (IoT_Payload.humedad);
